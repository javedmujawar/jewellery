...
import * as Plugin_0 from 'E:/React/jewellery/src/app.tsx';
import * as Plugin_1 from '@@/plugin-antd-icon-config/app.ts';
import * as Plugin_2 from 'E:/React/jewellery/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_0,
    path: 'E:/React/jewellery/src/app.tsx',
  });
  plugin.register({
    apply: Plugin_1,
  ...
  plugin.register({
    apply: Plugin_2,
    path: 'E:/React/jewellery/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
