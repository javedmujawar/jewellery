...
const CustomerCategoriesAdd = () => {
  ...
  const insertData = async (data) => {
    ...
    const result = await baseApi.request("customercategories", postData, "post");
        ...
        <Grid item xs={12}>
          ...
          >
            <Typography variant="h3">
              {isAddMode ? "Create Customer Categories" : "Edit Customer Categories"}
            </Typography>
            <div>
              <Button
                type="primary"
...
export default CustomerCategoriesAdd;
