...
const GstList = () => {
  ...
  const handlePDF = () => {
    ...
    const headers = [["Name", "Short Name","Percentage","IGST Value","CGST Value","SGST Value","Status"]];
    const tdata = data.map(elt=> [elt.name, elt.shortName,elt.percentageValue,elt.igstValue,elt.cgstValue,elt.sgstValue,elt.status]); 
